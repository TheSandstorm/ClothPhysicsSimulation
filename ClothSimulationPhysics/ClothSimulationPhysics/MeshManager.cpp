...
GLuint MeshManager::GrassGeometryQuadShader;
GLuint MeshManager::GrassGeometryShader;

MeshManager::MeshManager()
{
	GLuint VAO, VBO, EBO;
	FogCubeMapShader = ShaderLoader::CreateProgram(Shaders::FogCubeMapShaderVert.data(), Shaders::FogCubeMapShaderFrag.data());
	CubeMapShader = ShaderLoader::CreateProgram(Shaders::CubeMapShaderVert.data(), Shaders::CubeMapShaderFrag.data());
	FogModelShader = ShaderLoader::CreateProgram(Shaders::ModelFogShaderVert.data(), Shaders::ModelFogShaderFrag.data());
	FogObjectShader = ShaderLoader::CreateProgram(Shaders::FogShaderVert.data(), Shaders::FogShaderFrag.data());
	ObjectShader = ShaderLoader::CreateProgram(Shaders::ObjectShaderVert.data(), Shaders::ObjectShaderFrag.data());
	ModelShader = ShaderLoader::CreateProgram(Shaders::ModelShaderVert.data(), Shaders::ModelShaderFrag.data());
	StencilShader = ShaderLoader::CreateProgram(Shaders::ObjectShaderVert.data(), Shaders::SingleColorShaderFrag.data());
	GeometryShader = ShaderLoader::CreateProgram(Shaders::GeometryShaderRedVert.data(), Shaders::GrassShaderFrag.data(), Shaders::GeometryShaderGeom.data());
	GrassGeometryShader = ShaderLoader::CreateProgram(Shaders::GeometryShaderVert.data(), Shaders::GrassShaderFrag.data(), Shaders::GrassShaderGeom.data());
	GrassGeometryQuadShader = ShaderLoader::CreateProgram(Shaders::GeometryShaderVert.data(), Shaders::GrassQuadShaderFrag.data(), Shaders::GrassQuadShaderGeom.data());
...
GLuint MeshManager::GetShaderProgram(Shader_Attributes _ShaderType)
{
	...
	case GRASS_GEOMETRY_SHADER:
	{
		return GrassGeometryShader;
	}
	case GRASS_GEOMETRY_QUAD_SHADER:
	{
		return GrassGeometryQuadShader;
	}
