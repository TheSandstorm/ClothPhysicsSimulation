...
CubeMap::CubeMap() {
	...
	Shader = ShaderLoader::CreateProgram(Shaders::CubeMapShaderVert.data(), Shaders::CubeMapShaderFrag.data());
	...
	for (GLuint i = 0; i < 6; i++) {
		std::string PathName = TexturePaths::CubeMapTexture.data();
...
void CubeMap::Render() {
	...
	glm::mat4 MVP = CCamera::GetVPMatrix() * model;
